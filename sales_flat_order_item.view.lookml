- view: sales_flat_order_item
  sql_table_name: fwmagento.sales_flat_order_item
  fields:
  ...
  - dimension: require_login
    type: string
    sql: ${TABLE}.require_login
  ...
  - dimension: sold_by_length
    type: string
    sql: ${TABLE}.sold_by_length
  ...
  - dimension: zircon_product_name
    type: string
    sql: ${TABLE}.zircon_product_name

  - measure: count
    type: count
    drill_fields: [name, zircon_product_name]
